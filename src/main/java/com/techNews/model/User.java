...
//JsonIgnore specifies properties that should be ignored when serializing the object to JSON. The two arguments that follow that annotation are the properties to be ignored. Note that you could add main more if necessary.
